...
//  #define HSE_VALUE    ((uint32_t)25000000) /*!< Value of the External oscillator in Hz */
  #define HSE_VALUE    ((uint32_t)8000000) /*!< Value of the External oscillator in Hz */    // Modified by Dr. Samir A. Rawashdeh, for the STM32F4-Discovery Board, September 2013.
#endif /* HSE_VALUE */
